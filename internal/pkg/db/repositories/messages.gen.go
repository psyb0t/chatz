...
func newMessage(db *gorm.DB, opts ...gen.DOOption) message {
	...
	_message.Position = field.NewInt64(tableName, "position")
	_message.TurnID = field.NewField(tableName, "turn_id")
	_message.TurnComplete = field.NewBool(tableName, "turn_complete")
	_message.ModelID = field.NewString(tableName, "model_id")
	_message.ChatID = field.NewField(tableName, "chat_id")
	...
	_message.ProviderReasoning = field.NewField(tableName, "provider_reasoning")
	_message.ToolCalls = field.NewField(tableName, "tool_calls")
	_message.ToolCallID = field.NewString(tableName, "tool_call_id")
	_message.IsError = field.NewBool(tableName, "is_error")
	_message.IsInjection = field.NewBool(tableName, "is_injection")
	_message.UISpec = field.NewField(tableName, "ui_spec")
	_message.InputTokens = field.NewInt64(tableName, "input_tokens")
	_message.OutputTokens = field.NewInt64(tableName, "output_tokens")
...
type message struct {
	...
	TurnID            field.Field
	TurnComplete      field.Bool
	ModelID           field.String
	ChatID            field.Field
	Role              field.String
	Content           field.String
	Reasoning         field.String
	ProviderReasoning field.Field
	ToolCalls         field.Field
	ToolCallID        field.String
	IsError           field.Bool
	IsInjection       field.Bool
	UISpec            field.Field
	InputTokens       field.Int64
	OutputTokens      field.Int64
...
func (m *message) updateTableName(table string) *message {
	...
	m.Position = field.NewInt64(table, "position")
	m.TurnID = field.NewField(table, "turn_id")
	m.TurnComplete = field.NewBool(table, "turn_complete")
	m.ModelID = field.NewString(table, "model_id")
	m.ChatID = field.NewField(table, "chat_id")
	m.Role = field.NewString(table, "role")
	m.Content = field.NewString(table, "content")
	m.Reasoning = field.NewString(table, "reasoning")
	m.ProviderReasoning = field.NewField(table, "provider_reasoning")
	m.ToolCalls = field.NewField(table, "tool_calls")
	m.ToolCallID = field.NewString(table, "tool_call_id")
	m.IsError = field.NewBool(table, "is_error")
	m.IsInjection = field.NewBool(table, "is_injection")
	m.UISpec = field.NewField(table, "ui_spec")
	m.InputTokens = field.NewInt64(table, "input_tokens")
	m.OutputTokens = field.NewInt64(table, "output_tokens")
...
func (m *message) fillFieldMap() {
	...
	m.fieldMap["turn_complete"] = m.TurnComplete
	m.fieldMap["model_id"] = m.ModelID
	m.fieldMap["chat_id"] = m.ChatID
	m.fieldMap["role"] = m.Role
	m.fieldMap["content"] = m.Content
	m.fieldMap["reasoning"] = m.Reasoning
	m.fieldMap["provider_reasoning"] = m.ProviderReasoning
	m.fieldMap["tool_calls"] = m.ToolCalls
	m.fieldMap["tool_call_id"] = m.ToolCallID
	m.fieldMap["is_error"] = m.IsError
	m.fieldMap["is_injection"] = m.IsInjection
	m.fieldMap["ui_spec"] = m.UISpec
	m.fieldMap["input_tokens"] = m.InputTokens
	m.fieldMap["output_tokens"] = m.OutputTokens
}
